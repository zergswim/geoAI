...
def requestAPI_simple(tol, cls_id):
    ...
    response = requests.get(f"http://localhost:30001/geo-simlify/{tol}/{cls_id}") #, files=file, params=params)
...
#streamlit run index.py --server.port 30002 --server.fileWatcherType none
